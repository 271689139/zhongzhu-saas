...
import com.zhongzhu.framework.frequencyControl.FrequencyControlUtil;
import com.zhongzhu.framework.frequencyControl.bean.FixedWindowDTO;
import com.zhongzhu.framework.frequencyControl.bean.FrequencyControlDTO;
import com.zhongzhu.framework.frequencyControl.bean.SlidingWindowDTO;
import com.zhongzhu.framework.frequencyControl.bean.TokenBucketDTO;
import com.zhongzhu.framework.frequencyControl.constant.FrequencyControlConstant;
import com.zhongzhu.utils.common.IdGenerator;
import com.zhongzhu.utils.common.SpElUtils;
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.zhongzhu.framework.annotations.FrequencyControl)||@annotation(com.zhongzhu.framework.annotations.FrequencyControlContainer)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (int i = 0; i < annotationsByType.length; i++) {
            ...
            switch (frequencyControl.target()) {
                ...
                case UID:
                    // todo 可以获取当前登陆用户id
                    key = IdGenerator.generatorStringId();
            }

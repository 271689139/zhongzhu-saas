package com.zhongzhu.frequency.aop;


import com.zhongzhu.core.utils.IpUtil;
import com.zhongzhu.core.utils.SpElUtils;
import com.zhongzhu.frequency.FrequencyControlUtil;
import com.zhongzhu.frequency.annotations.FrequencyControl;
import com.zhongzhu.frequency.bean.FixedWindowDTO;
import com.zhongzhu.frequency.bean.FrequencyControlDTO;
...
public class FrequencyControlAspect {
    ...
    @Around("@annotation(com.zhongzhu.frequency.annotations.FrequencyControl)||@annotation(com.zhongzhu.frequency.annotations.FrequencyControlContainer)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (int i = 0; i < annotationsByType.length; i++) {
            ...
            /* 默认方法限定名 + 注解排名（可能多个）*/
            String prefix = StringUtil.isBlank(frequencyControl.prefixKey()) ? method.toGenericString() + ":index:" + i : frequencyControl.prefixKey();
            String key = "";

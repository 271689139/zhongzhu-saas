package com.zhongzhu.generator;
...
public class Generator {
    ...
    public static void main(String[] args) {
        //数据库连接 //数据库url
        String url = "jdbc:mysql://127.0.0.1:3307/lsh-dev?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false";
        //账号

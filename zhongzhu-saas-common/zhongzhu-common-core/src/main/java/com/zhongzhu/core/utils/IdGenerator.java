...
import com.zhongzhu.core.i18n.DateUtil;
...
public class IdGenerator {
    ...
    static class Snowflake {
        ...
        Snowflake(final long dataCenterId, final long machineId) {
            Assert.isTrue(machineId <= MAX_MACHINE && machineId >= 0, String.format("MachineId can't be greater than %s or less than 0", MAX_MACHINE));
            Assert.isTrue(dataCenterId <= MAX_DATACENTER && dataCenterId >= 0, String.format("DtaCenterId can't be greater than %s or less than 0", MAX_DATACENTER));

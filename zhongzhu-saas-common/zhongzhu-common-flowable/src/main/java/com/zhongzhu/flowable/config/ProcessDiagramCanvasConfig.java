...
public class ProcessDiagramCanvasConfig extends DefaultProcessDiagramCanvas {
    ...
    public ProcessDiagramCanvasConfig(int width, int height, int minX, int minY, String imageType, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader) {
